...
(function($, window, document, undefined) {
  ...
  runCode.prototype = {
    init: function() {
      var dialog = '<div class="preview-wrap"><div class="inner"><div class="bar"><span>编辑代码</span><span>预览</span><button class="btn-preview">运行</button><i class="btn-close-view">退出</i></div><div class="con"><pre><code id="codeContent" contenteditable name="editcode" class="js"></code></pre><iframe id="preview" frameborder="0"></iframe></div></div></div>';
